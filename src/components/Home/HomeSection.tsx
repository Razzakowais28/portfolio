              ...
              <div className="p-4 sm:p-6 md:p-8 flex flex-col gap-4 md:gap-6 text-left">
                ...
                <div className="space-y-1">
                  <h1 className="text-foreground text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight select-none leading-none">
                    Mohammed Owais<span className="text-foreground/30">.</span>
                  </h1>
                  ...
                  <div className="text-lg sm:text-xl md:text-2xl font-bold flex items-center min-h-8 leading-relaxed">
                    ...
                    <TypeAnimation
                      sequence={[
                        ...
                        'automate business workflows.', 2000,
                        'build scalable web applications.', 2000,
                        'integrate systems & APIs.', 2000,
                      ]}
                      speed={50}
                ...
                <p className="text-muted-foreground text-sm sm:text-base md:text-lg leading-relaxed max-w-3xl">
                  Software Developer with 3+ years of experience building web applications, automating workflows, and integrating systems across multiple organizations. Passionate about translating business requirements into practical, user-focused solutions.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-1 w-full font-mono">
                  ...
                  <a
                    href={`${import.meta.env.BASE_URL}Mohammed_Abdul_Razzak_Owais_Resume.pdf`}
                    target="_blank"
                ...
                <div className="flex space-x-3 sm:space-x-4 pt-2">
                  <a
                    href="https://github.com/Razzakowais28"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://www.linkedin.com/in/razzakowais"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="mailto:owaisrak28@gmail.com"
                    target="_blank"
                    rel="noopener noreferrer"
